...
const pool = new Pool({
  ...
  password: "123", // Hier ändern, falls PW anders
...
app.listen(PORT, () => {
  ...
  console.log("Organisation: http://localhost:5000/api/organisation");
  console.log("Einheiten: http://localhost:5000/api/units");
